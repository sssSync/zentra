    ...
    <div class="flex flex-col gap-6 text-black">
        ...
        <form method="POST" action="{{ route('login.store') }}" class="flex flex-col gap-6">
            ...
            <div class="flex items-center justify-end">
                <flux:button variant="primary" type="submit" class="text-white dark:text-black hover:bg-brand-green w-full"
        ...
        @if (Route::has('register'))
            <div class="space-x-1 text-sm text-center rtl:space-x-reverse text-gray-800 dark:text-white">
